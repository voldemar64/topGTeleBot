...
@bot.message_handler(content_types=types.ContentType.SUCCESSFUL_PAYMENT)
def success(message):
    bot.send_message(message.chat.id, f'Successful! {message.successful_payment.order_info}')
